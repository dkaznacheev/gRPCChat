...
public final class MessageSenderGrpc {
  ...
  public static final String SERVICE_NAME = "MessageSender";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<Chat.Message,
      Chat.Reply> getSendMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendMessage",
      requestType = Chat.Message.class,
      responseType = Chat.Reply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Chat.Message,
      Chat.Reply> getSendMessageMethod() {
    io.grpc.MethodDescriptor<Chat.Message, Chat.Reply> getSendMessageMethod;
      ...
      synchronized (MessageSenderGrpc.class) {
        if ((getSendMessageMethod = MessageSenderGrpc.getSendMessageMethod) == null) {
          MessageSenderGrpc.getSendMessageMethod = getSendMessageMethod = 
              io.grpc.MethodDescriptor.<Chat.Message, Chat.Reply>newBuilder()
  ...
  public static abstract class MessageSenderImplBase implements io.grpc.BindableService {
    ...
    public void sendMessage(Chat.Message request,
        io.grpc.stub.StreamObserver<Chat.Reply> responseObserver) {
  ...
  public static final class MessageSenderBlockingStub extends io.grpc.stub.AbstractStub<MessageSenderBlockingStub> {
    ...
    /**
     */
    public Chat.Reply sendMessage(Chat.Message request) {
  ...
  public static final class MessageSenderFutureStub extends io.grpc.stub.AbstractStub<MessageSenderFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Chat.Reply> sendMessage(
